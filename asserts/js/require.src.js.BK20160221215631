        ...
        context = {
            ...
            nameToUrl: function (moduleName, ext, skipExt) {
                ...
                if (req.jsExtRegExp.test(moduleName)) {
                    ...
                    url = syms.join('/');
                    url += (ext || (/^data\:|\?/.test(url) || skipExt ? '' : TPX.SUFFIX_JS));
...
require.config({
    paths: {
        ...
        'ueditor': '../ueditor1_4_3/ueditor.all',

        'user_editor.config': '../ueditor1_4_3/ueditor.config.user',
        'user_editor': '../ueditor1_4_3/ueditor.all',

        'upload_button': '../upload_button/upload_button',
