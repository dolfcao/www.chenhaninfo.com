...
class JavaScriptPacker {
	...
	private function _pack($script) {
		//$script = $this->_basicCompression($script);
		//$script=$this->_encodeKeywords($script);
		//$script=$this->_encodeSpecialChars($script);
		//return $script;
		//_basicCompression_encodeKeywords_basicCompression_encodeSpecialChars
		for ($i = 0; isset($this->_parsers[$i]); $i++) {
			//echo $this->_parsers[$i];echo '<hr />';
...
'function($charCode) {
    ...
    static function pack_js($src,$des)
	{
